...
4. **Consistency Checks** - Manual review using `oververse/worlds/iolanu/CONSISTENCY_CHECK.md`
...
5. Update `oververse/worlds/iolanu/CONSISTENCY_CHECK.md` if framework-related
...
- **World Consistency:** See `oververse/worlds/iolanu/CONSISTENCY_CHECK.md`
...
- [ ] Update `oververse/worlds/iolanu/CONSISTENCY_CHECK.md` if framework-related
