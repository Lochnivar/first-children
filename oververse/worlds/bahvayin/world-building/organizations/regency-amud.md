...
Amud sits in the eastern mid-Akhan, between Eithan and the central sea. Ships crossing the Akhan stop here. That is the duchy's primary economic fact — it is a convenient stop on routes that go elsewhere, and it has built a prosperous service economy around that convenience over two centuries.

The harbor offers provisioning, minor repairs, chandlery, and the hospitality infrastructure that grows up wherever maritime traffic pauses. The duchy does not produce anything distinctive. It services ships that are going somewhere else, and it does this reliably and at fair prices, and that has been sufficient.
...
Amud's culture is cosmopolitan in the specific way of transit ports — the population has seen every species and culture that passes through the inner Akhan and has developed a professional neutrality toward all of them. Not warmth, not hostility. Efficient, courteous service to whoever is paying for it. The duchy is not unfriendly. It is simply not particularly interested in anyone who is not currently a customer.
