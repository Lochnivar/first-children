# Bahvayin — World Bible

**Framework Summary:** [../bahvayin.md](../bahvayin.md)  
**Status:** Active world — in development  
**Related:** [../../FRAMEWORK.md](../../../FRAMEWORK.md)  
**AI Context Primer:** [AI-PRIMER.md](AI-PRIMER.md) — paste into new sessions to restore working context

## World at a Glance

Bahvayin (*bah-VAH-yin*) is an atoll surrounding the Akhan Sea — the inner sea itself approximately 1.75x the size of the Mediterranean, the atoll rim extending further beyond. A maritime empire is dying — too many heirs, not enough throne. The Eye of Tsapadon is coming. The breakwater islands are being sabotaged. The engineer-priests have the math but not the political access. The emperor has divine right and no engineering knowledge. Nobody is paying attention to what comes through the Storm Gate during the surge.

**Authorial register:** Ground level. Stories follow common folk, junior functionaries, third sons, dock workers, the people far below the succession crisis who feel every consequence of it. The meta-narrative is assembled from fragments, never explained from above.

---

## World-Building Index

### [Geography](world-building/geography/)
- [World Overview](world-building/geography/overview.md) — Atoll structure, three arcs (Grenmarch/Dashamar/Harova), the Archavar, the Yeorvan, Tal Aegis
- [The Storm Gate](world-building/geography/storm-gate.md) — Eastern strait, breakwater islands, surge mechanics
- [The Desert Road](world-building/geography/desert-road.md) — Western strait, nomad passage, survival corridor
- [The Southern Way](world-building/geography/southern-way.md) — Curved southern strait, warm current, fog belt

### [History & Events](world-building/history-events/)
- [Deep History](world-building/history-events/deep-history.md) — Creation myth, predecessor civilization, unresolved questions
- [The Mageocracy](world-building/history-events/mageocracy.md) — High magic era, institutional collapse, what got left behind
- [The Death of Magic](world-building/history-events/death-of-magic.md) — The FC course correction event, mortal experience of it
- [The Empire — Rise](world-building/history-events/empire-rise.md) — Foundation, expansion, the intermarriage strategy
- [The Empire — Decline](world-building/history-events/empire-decline.md) — Succession crisis, the cousin problem, current political state

### [Cosmology & Theology](world-building/cosmology/)
- [The Pantheon](world-building/cosmology/pantheon.md) — Eight deities, portfolios, relationships
- [Imperial Religion](world-building/cosmology/imperial-religion.md) — Sheltering Hand theology, Tsapadon cult, emperor as cosmic administrator
- [Storm Gate Theology](world-building/cosmology/storm-gate-theology.md) — Engineer-priest theology, the Eye as divine attention, the breakwater as offering

### [Cultures](world-building/cultures/)
- [Storm Gate Culture](world-building/cultures/storm-gate-culture.md) — Engineer-priests, breakwater civilization, apocalyptic calendar
- [Desert Road Culture](world-building/cultures/desert-road-culture.md) — Djemari nomads, water knowledge, the Desert Road as institution
- [Southern Way Culture](world-building/cultures/southern-way-culture.md) — Fog navigators, warm current peoples, port culture
...
### [Magic Systems](world-building/magic-systems/)
- [The Death of Magic](world-building/magic-systems/death-of-magic.md) — What magic was, how it ended, what persists
- [Pre-Death Artifacts](world-building/magic-systems/artifacts.md) — Frozen enchantments, their nature, why no new ones exist
- [Residual Ability](world-building/magic-systems/residual-ability.md) — Individuals born with fragments, persecution, political context

### [Natural World](world-building/natural-world/)
- [The Outer Ocean](world-building/natural-world/outer-ocean.md) — Lesser Dragons, Kobolds, why the fear is justified
- [Ruins & Dungeons](world-building/natural-world/ruins-dungeons.md) — Mageocracy remnants, Orcus genus, sealed and leaking sites
- [The Storm Cycle](world-building/natural-world/storm-cycle.md) — Ordinary Gate surge vs. the Eye, meteorological mechanics

---

## Naming Conventions

**World name:** Bahvayin (*bah-VAH-yin*) — stress on second syllable. Formal usage. Common: "the Vah" or simply Bahvayin depending on register.

**Inner sea:** The Akhan Sea — formal. The Akhan — common usage.

**The three straits:** The Storm Gate, The Desert Road, The Southern Way. All take "the" as article. Sailors use the full names; no common abbreviations established yet.

**Deity names:** Shamur, Tsapadon, Yameth, Mothar, Kadoru, Nurathi, Azaron, Dinath. Semitic-adjacent roots, not directly Canaanite/Mesopotamian. Background texture — never front-line actors.
...
- FC experimenters are unnamed and uncharacterized. Their presence is felt only in the world's design — the geography, the species distribution, the Death of Magic course correction. They do not appear in stories.
- The pantheon exists as background infrastructure. Gods are invoked by mortals, argued about, gone to war over. They do not appear.
- The meta-narrative (dying dynasty, Eye cycle, breakwater sabotage) is the container. Stories live inside it at ground level.
- Magic items are archaeological artifacts — studied, hoarded, occasionally activated by accident. Not common equipment.
- The "thar be dragons" outer ocean is real. Do not send characters out there casually.

---

*Framework summary: [../bahvayin.md](../bahvayin.md)*  
*Framework overview: [../../../FRAMEWORK.md](../../../FRAMEWORK.md)*
