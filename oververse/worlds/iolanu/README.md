...
- **[plots/](plots/README.md)** - Story arcs, scenes, and plot threads
- **[relationships/](relationships/README.md)** - Character relationship documentation
- **[timeline/](timeline/README.md)** - Chronological event tracking
- **[meta/](meta/)** - Project documentation (premise, tone, perspective, discrepancies)
- **[archive/](archive/)** - Raw AI-DUMP files and extraction status (for reference only)

## Quick Navigation

### Series Structure
- **Book 1:** [The Nalan Apostasy](plots/arcs/book1-the-nalan-apostasy.md) - Orientation tour through Gabby's eyes
- **Book 2:** [Godshard Quest](plots/arcs/book2_godshard_quest.md) - Quest for the missing 7th Godshard (Title TBD)
...
- Uses soul transfer (Earth souls) as a liberation tool
- Manifests Quantumancy fragments in mortals (quantum abilities)
- Follows liberation story patterns established in the framework
...
The Hypatia framework is the source of truth: [Framework Documentation](../../FRAMEWORK.md)

## Documentation Philosophy

This world bible follows a structured approach:
- **Canon vs. Provisional:** Content marked as provisional is exploratory and subject to change
- **Cross-References:** Related content is linked for easy navigation
- **Templates:** Each category has templates for consistent documentation
