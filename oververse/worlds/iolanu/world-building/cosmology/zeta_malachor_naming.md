...
- The name has changed over time as history progressed through different "ages of man"
- **Zeta** - Name from earlier age(s)
- **Malachor** - Name from current/later age(s)
- The progression reflects how the god is known/referred to in different historical periods

### Current Usage
- **Church of Malachor** - Uses the current name "Malachor"
- **Formal/Religious contexts** - Likely use "Malachor"
- **Historical references** - May use "Zeta" when referring to earlier periods
- **Earth souls** - May use "Zeta" or slang terms like "Zetahat" / "Jet hat"

## Slang Terms

### Earth Soul Slang
- **"Zetahat"** - Play on "asshat" (derogatory)
- **"Jet hat"** - Alternative slang term
- Used by Earth souls who know the god's original/earlier name
...
- No need to standardize on one name - both are canonically correct for their respective contexts
