...
- **Pick what fits:** Worlds choose which races to include based on their needs
- **Not exhaustive:** The list is expandable; new races are added as needed
- **Common framework:** All Hypatia-aligned worlds share this pool of options
- **World-specific use:** A race may or may not appear on any given world
...
### Adversary Frameworks (Trial Use Only)
- **[Genus Orcus](orcus/genus.md)** - Designed adversary template for trials. NOT staff.
  - [Goblins](orcus/goblins.md) (Orcus minor) - Swarm mobs
  - [Orcs](orcus/orcs.md) (Orcus sapiens) - Standard combat
...
- Individual worlds may include all, some, or none of these races
...
See **[Genetic Frameworks](genetic-frameworks.md)** for:
- The genetic repo (why everything looks familiar)
...
- Framework races are universal options—use as needed
- Worlds can include, exclude, or modify races
- Worlds can add unique races not in framework
- More races will be added as warranted
