...
- **Variable lifespan** — Model-dependent (humans moderate; elves extended)
- **Adaptable build** — Generalist template allows specialization

### Temperament
- **Role-defined** — Each species built for specific function
- **Professional hierarchy** — Specialists > generalists in their domain
