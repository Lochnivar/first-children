...
### Homo Sapiens
- Generalist (adaptable to many roles)
...
### Physical Attributes
- **Lifespan:** Moderate (typically 70-90 years, varies by world)
- **Size:** Variable, typically 5-6 feet
- **Build:** Adaptable

### Cognitive Abilities
- **Intelligence:** Fully intelligent, highly adaptable
- **Learning:** Quick learners across domains
- **Adaptability:** Core trait—thrive in varied environments

## Variations Across Worlds

Humans manifest differently across worlds. Earth humans are the primary reference. Trial worlds may have transformed or converted human populations.

---

*For Homo genus, see [Genetic Frameworks](../genetic-frameworks.md)*  
